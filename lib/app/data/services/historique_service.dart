      ...
      if (response != null &&
        ...
        return results.map((item) {
          ...
          return {
            ...
            'descriptionJustification': item['descriptionJustification'] ?? '',
            'piecesJointes': item['piecesJointes'] ?? [],
            'statutJustification': item['statutJustification'] ?? '',
            'dateValidationJustification': item['dateValidationJustification'],
